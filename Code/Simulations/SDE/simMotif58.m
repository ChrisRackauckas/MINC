function [RA,RAR,RAinit,RARinit,tRAv,tRARv,RABP,R,BP] = simMotif58(vars,crabp,cypmax,N,dt,stream)
...
for i=2:N
	RAout(i)= RAout(i-1)+ (beta - b*RAout(i-1) + c*RA(i-1))*dt + sigma*sqrt(dt)*RAout(i-1)*randn(stream);
